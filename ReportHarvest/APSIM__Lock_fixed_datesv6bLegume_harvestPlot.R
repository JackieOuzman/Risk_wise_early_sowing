...
Early_sowing_Lock_met_decile_Legume <- read_csv(paste0(
            "N:/work/Riskwise/early_sowing/Lock/For_Decile_cal/Legume/",
            "/APSIM_yld_Decile_Lock18046_No_summary", ".csv"))
           
Early_sowing_Lock_met_decile_Legume <- Early_sowing_Lock_met_decile_Legume %>% 
...
## both yields 
str(Early_sowing_Lock_met_decile_Legume)
Early_sowing_Lock_met_decile_long <- Early_sowing_Lock_met_decile_Legume %>%
  pivot_longer(
...
Early_sowing_Lock_met_decile_summary <- Early_sowing_Lock_met_decile_Legume %>% 
  group_by(DOY_sowing) %>% 
...
ggsave(plot = plot3_point,
       filename = paste0(path_saved_files,"/Frostyield_and_yldvs_Sowing_dates_Lock_Legume", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot2_hisrogram,
       filename = paste0(path_saved_files,"/histogram_facet_Frostyield_and_yldvs_Sowing_dates_Lock_legume", ".png" ),
       width = 20, height = 12, units = "cm")
