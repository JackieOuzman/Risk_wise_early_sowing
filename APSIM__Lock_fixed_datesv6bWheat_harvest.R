...
file_name   <- "Lock_fixed_Pengcheng_HF_rule at harvest"
# "D:\work\RiskWise\early_sowing\Lock\APSIM_runs\Wheat\Lock_fixed_Pengcheng_HF_rule.db"
con <- dbConnect(SQLite(),  "N:/work/RiskWise/early_sowing/Lock/APSIM_runs/Wheat/Lock_fixed_Pengcheng_HF_rule at harvest.db")
dbListTables(con)
...
Early_sowing_Lock_met_decile <- Early_sowing_Lock_met_decile %>% 
   ...
   select(year, StartDate, decile, 
          Yield, FrostHeatDamageFunctions.FrostHeatYield, 
...
Early_sowing_Lock_met_decile$harvest_date <- as.Date(Early_sowing_Lock_met_decile$harvest_date)
