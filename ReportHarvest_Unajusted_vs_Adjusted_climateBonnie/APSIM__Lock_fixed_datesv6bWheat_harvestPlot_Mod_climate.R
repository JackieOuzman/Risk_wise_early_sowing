...
ggsave(plot = plot_frost_count,
       filename = paste0(path_saved_files,"/plot_frost_count_Lock_wheat_All", ".png" ),
...
ggsave(plot = plot1_box,
       filename = paste0(path_saved_files,"/Box_yield_vs_Sowing_dates_Lock_wheat_All", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot3_point,
       filename = paste0(path_saved_files,"/Frostyield_and_yldvs_Sowing_dates_Lock_WheatAll", ".png" ),
       width = 20, height = 12, units = "cm")
...
ggsave(plot = plot2_hisrogram,
       filename = paste0(path_saved_files,"/histogram_facet_Frostyield_and_yldvs_Sowing_dates_Lock_WheatAll", ".png" ),
       width = 20, height = 12, units = "cm")
